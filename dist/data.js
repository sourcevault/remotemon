...
x$.arr = ['ssh', 'var', 'pre', 'inpwd', 'watch', 'rsync', 'local', 'final', 'ignore', 'defarg', 'remote', 'silent', 'verbose', 'initialize', 'remotefold', 'remotehost', 'description', 'defarg.required'];
x$.undef = ['ssh', 'watch', 'inpwd', 'ignore', 'silent', 'verbose', 'initialize', 'remotefold', 'remotehost'];
