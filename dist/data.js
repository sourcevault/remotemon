...
x$.arr = ['ssh', 'pre', 'inpwd', 'watch', 'rsync', 'local', 'final', 'global', 'ignore', 'defarg', 'remote', 'verbose', 'initialize', 'remotefold', 'remotehost', 'description'];
x$.undef = ['ssh', 'watch', 'inpwd', 'global', 'ignore', 'verbose', 'initialize', 'remotefold', 'remotehost'];
