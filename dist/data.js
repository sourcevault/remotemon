...
x$.arr = ['ssh', 'watch', 'rsync', 'global', 'ignore', 'defarg', 'locale', 'remote', 'finale', 'verbose', 'initialize', 'remotefold', 'remotehost', 'description'];
x$.undef = ['ssh', 'watch', 'locale', 'remote', 'finale', 'global', 'ignore', 'verbose', 'initialize', 'remotefold', 'remotehost'];
