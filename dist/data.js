...
x$.arr = ['ssh', 'watch', 'rsync', 'local', 'final', 'global', 'ignore', 'defarg', 'remote', 'verbose', 'initialize', 'remotefold', 'remotehost', 'description'];
x$.undef = ['ssh', 'watch', 'local', 'remote', 'final', 'global', 'ignore', 'verbose', 'initialize', 'remotefold', 'remotehost'];
