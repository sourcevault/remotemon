...
var source = __webpack_require__(87357);
...
const defaultSheet = {
  ...
  keyword: source.green,
  'selector-tag': source.green,
  addition: source.green,

  number: source.cyan,
  string: source.cyan,
  'meta meta-string': source.cyan,
  literal: source.cyan,
  doctag: source.cyan,
  regexp: source.cyan,
  ...
  section: source.blue,
  name: source.blue,
  'selector-id': source.blue,
  'selector-class': source.blue,

  attribute: source.yellow,
  attr: source.yellow,
  variable: source.yellow,
  'template-variable': source.yellow,
  'class title': source.yellow,
  type: source.yellow,

  symbol: source.magenta,
  bullet: source.magenta,
  subst: source.magenta,
  meta: source.magenta,
  'meta keyword': source.magenta,
  'selector-attr': source.magenta,
  'selector-pseudo': source.magenta,
  link: source.magenta,
  ...
  emphasis: source.italic,
  strong: source.bold,
  formula: source.inverse
}
...
;// CONCATENATED MODULE: ./node_modules/emphasize/index.js
